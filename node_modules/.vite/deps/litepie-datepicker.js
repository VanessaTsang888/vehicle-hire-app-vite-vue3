  ...
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t, e) {
      ...
      var t = 1e3, e = 6e4, n = 36e5, r = "millisecond", i = "second", s2 = "minute", u = "hour", a = "day", o = "week", f = "month", h2 = "quarter", c = "year", d2 = "date", $ = "Invalid Date", l = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M2 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_") }, m2 = function(t2, e2, n2) {
        ...
        return { M: f, y: c, w: o, d: a, D: d2, h: u, m: s2, s: i, ms: r, Q: h2 }[t2] || String(t2 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t2) {
        return t2 === void 0;
      } }, v = "en", D = {};
      D[v] = M2;
      ...
      var _ = function() {
        ...
        return m3.parse = function(t2) {
          ...
          }, y3 = this.$W, M4 = this.$M, m4 = this.$D, g2 = "set" + (this.$u ? "UTC" : "");
          switch (h3) {
            case c:
          ...
          var n2, o2 = O.p(t2), h3 = "set" + (this.$u ? "UTC" : ""), $2 = (n2 = {}, n2[a] = h3 + "Date", n2[d2] = h3 + "Date", n2[f] = h3 + "Month", n2[c] = h3 + "FullYear", n2[u] = h3 + "Hours", n2[s2] = h3 + "Minutes", n2[i] = h3 + "Seconds", n2[r] = h3 + "Milliseconds", n2)[o2], l2 = o2 === a ? this.$D + (e2 - this.$W) : e2;
          if (o2 === f || o2 === c) {
          ...
          if (l2 === o)
            return y3(7);
          var M4 = (d3 = {}, d3[s2] = e, d3[u] = n, d3[i] = t, d3)[l2] || 1, m4 = this.$d.getTime() + r2 * M4;
          return O.w(m4, this);
          ...
          var r2 = t2 || "YYYY-MM-DDTHH:mm:ssZ", i2 = O.z(this), s3 = this.$H, u2 = this.$m, a2 = this.$M, o2 = n2.weekdays, f2 = n2.months, h3 = function(t3, n3, i3, s4) {
          ...
          }, l2 = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: a2 + 1, MM: O.s(a2 + 1, 2, "0"), MMM: h3(n2.monthsShort, a2, f2, 3), MMMM: h3(f2, a2), D: this.$D, DD: O.s(this.$D, 2, "0"), d: String(this.$W), dd: h3(n2.weekdaysMin, this.$W, o2, 2), ddd: h3(n2.weekdaysShort, this.$W, o2, 3), dddd: o2[this.$W], H: String(s3), HH: O.s(s3, 2, "0"), h: c2(1), hh: c2(2), a: d3(s3, u2, true), A: d3(s3, u2, false), m: String(u2), mm: O.s(u2, 2, "0"), s: String(this.$s), ss: O.s(this.$s, 2, "0"), SSS: O.s(this.$ms, 3, "0"), Z: i2 };
          ...
          var l2, y3 = O.p(d3), M4 = w(r2), m4 = (M4.utcOffset() - this.utcOffset()) * e, g2 = this - M4, v2 = O.m(this, M4);
          return v2 = (l2 = {}, l2[c] = v2 / 12, l2[f] = v2, l2[h2] = v2 / 3, l2[o] = (g2 - m4) / 6048e5, l2[a] = (g2 - m4) / 864e5, l2[u] = g2 / n, l2[s2] = g2 / e, l2[i] = g2 / t, l2)[y3] || g2, $2 ? v2 : O.a(v2);
    ...
    !function(n, e) {
      ...
      return function(n, e, t) {
        var r = e.prototype, o = function(n2) {
          ...
          var i2 = n2.name ? n2 : n2.$locale(), a2 = o(i2[e2]), s3 = o(i2[t2]), f = a2 || s3.map(function(n3) {
...
var require_customParseFormat = __commonJS({
  "node_modules/dayjs/plugin/customParseFormat.js"(exports, module) {
    !function(t, e) {
      ...
      "use strict";
      var t = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, e = /(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, n = /\d\d/, r = /\d\d?/, i = /\d*[^\s\d-_:/()]+/, o = {}, s2 = function(t2) {
      ...
      function c(n2) {
        ...
        })).match(e), a2 = s3.length, f2 = 0; f2 < a2; f2 += 1) {
          var u2 = s3[f2], h3 = d2[u2], c2 = h3 && h3[0], l = h3 && h3[1];
          s3[f2] = l ? { regex: c2, parser: l } : u2.replace(/^\[|\]$/g, "");
        }
        return function(t2) {
      ...
      return function(t2, e2, n2) {
        ...
        r2.parse = function(t3) {
          ...
          var a2 = s3[1];
          if (typeof a2 == "string") {
            var f2 = s3[2] === true, u2 = s3[3] === true, h3 = f2 || u2, d3 = s3[2];
            u2 && (d3 = s3[2]), o = this.$locale(), !f2 && d3 && (o = n2.Ls[d3]), this.$d = function(t4, e4, n3) {
              try {
                if (["x", "X"].indexOf(e4) > -1)
                  return new Date((e4 === "X" ? 1e3 : 1) * t4);
                var r4 = c(e4)(t4), i3 = r4.year, o2 = r4.month, s4 = r4.day, a3 = r4.hours, f3 = r4.minutes, u3 = r4.seconds, h4 = r4.milliseconds, d4 = r4.zone, l2 = new Date(), m3 = s4 || (i3 || o2 ? 1 : l2.getDate()), M3 = i3 || l2.getFullYear(), Y = 0;
                i3 && !o2 || (Y = o2 > 0 ? o2 - 1 : l2.getMonth());
                var p = a3 || 0, v = f3 || 0, D = u3 || 0, g = h4 || 0;
                return d4 ? new Date(Date.UTC(M3, Y, m3, p, v, D, g + 60 * d4.offset * 1e3)) : n3 ? new Date(Date.UTC(M3, Y, m3, p, v, D, g)) : new Date(M3, Y, m3, p, v, D, g);
              } catch (t5) {
                return new Date("");
              }
            }(e3, a2, r3), this.init(), d3 && d3 !== true && (this.$L = this.locale(d3).$L), h3 && e3 != this.format(a2) && (this.$d = new Date("")), o = {};
  ...
  "node_modules/dayjs/plugin/isBetween.js"(exports, module) {
    !function(e, i) {
      ...
      return function(e, i, t) {
        i.prototype.isBetween = function(e2, i2, s2, f) {
          var n = t(e2), o = t(i2), r = (f = f || "()")[0] === "(", u = f[1] === ")";
          return (r ? this.isAfter(n, s2) : !this.isBefore(n, s2)) && (u ? this.isBefore(o, s2) : !this.isAfter(o, s2)) || (r ? this.isBefore(n, s2) : !this.isAfter(n, s2)) && (u ? this.isAfter(o, s2) : !this.isBefore(o, s2));
        };
      };
    });
  }
...
var require_duration = __commonJS({
  "node_modules/dayjs/plugin/duration.js"(exports, module) {
    !function(t, s2) {
      typeof exports == "object" && typeof module != "undefined" ? module.exports = s2() : typeof define == "function" && define.amd ? define(s2) : (t = typeof globalThis != "undefined" ? globalThis : t || self).dayjs_plugin_duration = s2();
    }(exports, function() {
      "use strict";
      var t, s2, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, u = 31536e6, h2 = 2592e6, a = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, d2 = { years: u, months: h2, days: r, hours: e, minutes: i, seconds: n, milliseconds: 1, weeks: 6048e5 }, c = function(t2) {
        ...
        return t2 ? l(t2) ? { negative: true, format: "" + y2(t2) + s3 } : { negative: false, format: "" + t2 + s3 } : { negative: false, format: "" };
      }, p = function() {
        function l2(t2, s3, n2) {
          var i2 = this;
          if (this.$d = {}, this.$l = n2, t2 === void 0 && (this.$ms = 0, this.parseFromMilliseconds()), s3)
            return f(t2 * d2[m2(s3)], this);
          if (typeof t2 == "number")
        ...
        return y3.calMilliseconds = function() {
          ...
          var u2 = g(o2, "S"), h3 = t2.negative || s3.negative || i2.negative || e2.negative || r2.negative || u2.negative, a2 = e2.format || r2.format || u2.format ? "T" : "", d3 = (h3 ? "-" : "") + "P" + t2.format + s3.format + i2.format + a2 + e2.format + r2.format + u2.format;
          return d3 === "P" || d3 === "-P" ? "P0D" : d3;
        }, y3.toJSON = function() {
          return this.toISOString();
        }, y3.format = function(t2) {
          ...
          return this.$ms / d2[m2(t2)];
        }, y3.get = function(t2) {
          var s3 = this.$ms, n2 = m2(t2);
          return n2 === "milliseconds" ? s3 %= 1e3 : s3 = n2 === "weeks" ? $(s3 / d2[n2]) : this.$d[n2], s3 === 0 ? 0 : s3;
        }, y3.add = function(t2, s3, n2) {
          var i2;
          return i2 = s3 ? t2 * d2[m2(s3)] : c(t2) ? t2.$ms : f(t2, this).$ms, f(this.$ms + i2 * (n2 ? -1 : 1), this);
        }, y3.subtract = function(t2, s3) {
          return this.add(t2, s3, true);
        }, y3.locale = function(t2) {
          var s3 = this.clone();
          return s3.$l = t2, s3;
        }, y3.clone = function() {
...
// node_modules/litepie-datepicker/dist/litepie-datepicker.esm.js
...
var useCurrentDate = (date) => {
  return Array.from({
    length: date.daysInMonth()
  }, (v, k) => date.date(k + 1));
};
var useNextDate = (date) => {
  const display = [];
...
var useToValueFromString = (date, {
  formatter
}) => {
  return date.format(formatter.date);
};
var useToValueFromArray = ({
  previous,
  next
}, {
  formatter,
...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    ...
    case "./locale/ar-dz.js":
      return Promise.resolve().then(function() {
        return arDz;
      });
    case "./locale/ar-kw.js":
      return Promise.resolve().then(function() {
        return arKw;
      });
    case "./locale/ar-ly.js":
      return Promise.resolve().then(function() {
        return arLy;
      });
    case "./locale/ar-ma.js":
      return Promise.resolve().then(function() {
        return arMa;
      });
    case "./locale/ar-sa.js":
      return Promise.resolve().then(function() {
        return arSa;
      });
    case "./locale/ar-tn.js":
      return Promise.resolve().then(function() {
        return arTn;
      });
    case "./locale/ar.js":
    ...
    case "./locale/de-at.js":
      return Promise.resolve().then(function() {
        return deAt;
      });
    case "./locale/de-ch.js":
      return Promise.resolve().then(function() {
        return deCh;
      });
    case "./locale/de.js":
    ...
    case "./locale/en-au.js":
      return Promise.resolve().then(function() {
        return enAu;
      });
    case "./locale/en-ca.js":
      return Promise.resolve().then(function() {
        return enCa;
      });
    case "./locale/en-gb.js":
      return Promise.resolve().then(function() {
        return enGb;
      });
    case "./locale/en-ie.js":
      return Promise.resolve().then(function() {
        return enIe;
      });
    case "./locale/en-il.js":
      return Promise.resolve().then(function() {
        return enIl;
      });
    case "./locale/en-in.js":
      return Promise.resolve().then(function() {
        return enIn;
      });
    case "./locale/en-nz.js":
      return Promise.resolve().then(function() {
        return enNz;
      });
    case "./locale/en-sg.js":
      return Promise.resolve().then(function() {
        return enSg;
      });
    case "./locale/en-tt.js":
      return Promise.resolve().then(function() {
        return enTt;
      });
    case "./locale/en.js":
    ...
    case "./locale/es-do.js":
      return Promise.resolve().then(function() {
        return esDo;
      });
    case "./locale/es-pr.js":
      return Promise.resolve().then(function() {
        return esPr;
      });
    case "./locale/es-us.js":
      return Promise.resolve().then(function() {
        return esUs;
      });
    case "./locale/es.js":
    ...
    case "./locale/fr-ca.js":
      return Promise.resolve().then(function() {
        return frCa;
      });
    case "./locale/fr-ch.js":
      return Promise.resolve().then(function() {
        return frCh;
      });
    case "./locale/fr.js":
    ...
    case "./locale/oc-lnc.js":
      return Promise.resolve().then(function() {
        return ocLnc;
      });
    case "./locale/pa-in.js":
      return Promise.resolve().then(function() {
        return paIn;
      });
    case "./locale/pl.js":
    ...
    case "./locale/zh-hk.js":
      return Promise.resolve().then(function() {
        return zhHk;
      });
    case "./locale/zh-tw.js":
      return Promise.resolve().then(function() {
        return zhTw;
      });
    case "./locale/zh.js":
...
var script$6 = defineComponent({
  ...
  setup(props, {
    ...
    const datepicker = ref({
      previous: (0, import_dayjs.default)(),
      next: (0, import_dayjs.default)().add(1, "month"),
      year: {
        previous: (0, import_dayjs.default)().year(),
        next: (0, import_dayjs.default)().year()
      },
      weeks: import_dayjs.default.weekdaysShort(),
      months: props.formatter.month === "MMM" ? import_dayjs.default.monthsShort() : import_dayjs.default.months()
    });
    const weeks = computed(() => datepicker.value.weeks);
    const months7 = computed(() => datepicker.value.months);
    const calendar = computed(() => {
      ...
      return {
        previous: {
          date: () => {
            return usePreviousDate(previous2).concat(useCurrentDate(previous2)).concat(useNextDate(previous2)).map((v) => {
              v.today = v.isToday();
              v.active = previous2.month() === v.month();
              v.off = previous2.month() !== v.month();
              v.sunday = v.day() === 0;
              v.disabled = useDisableDate(v, props) && !v.isToday() && !inRangeDate(v);
              v.inRange = () => {
                if (props.asSingle && !props.useRange) {
                  return previous2.month() !== v.month();
                }
              };
              v.hovered = () => {
                if (!asRange())
                ...
                if (hoverValue.value.length > 1) {
                  return (v.isBetween(hoverValue.value[0], hoverValue.value[1], "date", "()") || v.isBetween(hoverValue.value[1], hoverValue.value[0], "date", "()")) && previous2.month() === v.month();
                }
                return false;
              };
              v.duration = () => {
          ...
          month: previous2 && previous2.format(props.formatter.month),
          year: previous2 && previous2.year(),
          years: () => {
            return Array.from({
              length: 12
            }, (v, k) => year.previous + k);
          ...
          onPrevious: () => {
            datepicker.value.previous = previous2.subtract(1, "month");
          },
          onNext: () => {
            datepicker.value.previous = previous2.add(1, "month");
            if (previous2.diff(next2, "month") === -1) {
              datepicker.value.next = next2.add(1, "month");
            }
          },
          onPreviousYear: () => {
          ...
          setMount: ($event) => {
            datepicker.value.previous = previous2.month($event);
            panel.previous.month = !panel.previous.month;
            panel.previous.year = false;
            panel.previous.calendar = !panel.previous.month;
            nextTick(() => {
          ...
          setYear: ($event, asNext) => {
            if (!asNext) {
              datepicker.value.previous = previous2.year($event);
              panel.previous.year = !panel.previous.year;
              panel.previous.calendar = !panel.previous.year;
              nextTick(() => {
                if (datepicker.value.next.isSame(datepicker.value.previous, "month") || datepicker.value.next.isBefore(datepicker.value.previous)) {
        ...
        next: {
          date: () => {
            return usePreviousDate(next2).concat(useCurrentDate(next2)).concat(useNextDate(next2)).map((v) => {
              v.today = v.isToday();
              v.active = next2.month() === v.month();
              v.off = next2.month() !== v.month();
              v.sunday = v.day() === 0;
              v.disabled = useDisableDate(v, props) && !v.isToday() && !inRangeDate(v);
              v.inRange = () => {
                if (props.asSingle && !props.useRange) {
                  return next2.month() !== v.month();
                }
              };
              v.hovered = () => {
                if (hoverValue.value.length > 1) {
                  return (v.isBetween(hoverValue.value[0], hoverValue.value[1], "date", "()") || v.isBetween(hoverValue.value[1], hoverValue.value[0], "date", "()")) && next2.month() === v.month();
                }
                return false;
              };
              v.duration = () => {
          ...
          month: next2 && next2.format(props.formatter.month),
          year: next2 && next2.year(),
          years: () => {
            return Array.from({
              length: 12
            }, (v, k) => year.next + k);
          ...
          onPrevious: () => {
            datepicker.value.next = next2.subtract(1, "month");
            if (next2.diff(previous2, "month") === 1) {
              datepicker.value.previous = previous2.subtract(1, "month");
            }
          },
          onNext: () => {
          ...
          setMount: ($event) => {
            datepicker.value.next = next2.month($event);
            panel.next.month = !panel.next.month;
            panel.next.year = false;
            panel.next.calendar = !panel.next.month;
            nextTick(() => {
          ...
          setYear: ($event, asNext) => {
            if (asNext) {
              datepicker.value.next = next2.year($event);
              panel.next.year = !panel.next.year;
              panel.next.month = false;
              panel.next.calendar = !panel.next.year;
              nextTick(() => {
    ...
    const inRangeDate = (date) => {
      ...
      return date.isBetween((0, import_dayjs.default)(s2, props.formatter.date, true), (0, import_dayjs.default)(e, props.formatter.date, true), "date", "[]");
    };
    const show = () => {
      isShow.value = true;
    };
    ...
    const keyUp = () => {
      if (asRange()) {
        const [s2, e] = pickerValue.value.split(props.separator);
        const [sd2, ed] = [(0, import_dayjs.default)(s2, props.formatter.date, true), (0, import_dayjs.default)(e, props.formatter.date, true)];
        if (sd2.isValid() && ed.isValid()) {
          setDate(sd2);
          setDate(ed);
          if (useArray()) {
            emit("update:modelValue", [s2, e]);
          } else if (useObject()) {
            const obj = {};
            const [start, end] = Object.keys(props.modelValue);
            obj[start] = s2;
        ...
        const d2 = (0, import_dayjs.default)(pickerValue.value, props.formatter.date, true);
        if (d2.isValid()) {
          setDate(d2);
          if (useArray()) {
      ...
      if (asRange()) {
        if (previous.value) {
          ...
          if (props.autoApply) {
            ...
            const [s2, e] = pickerValue.value.split(props.separator);
            if (useArray()) {
              emit("update:modelValue", [(0, import_dayjs.default)(s2, props.formatter.date, true).format(props.formatter.date), (0, import_dayjs.default)(e, props.formatter.date, true).format(props.formatter.date)]);
            } else if (useObject()) {
              const obj = {};
              const [start, end] = Object.keys(props.modelValue);
              obj[start] = s2;
              ...
              emit("update:modelValue", useToValueFromArray({
                previous: (0, import_dayjs.default)(s2, props.formatter.date, true),
                next: (0, import_dayjs.default)(e, props.formatter.date, true)
              }, props));
            }
            isShow.value = false;
            applyValue.value = [];
            if (!(0, import_dayjs.default)(s2, props.formatter.date, true).isSame((0, import_dayjs.default)(e, props.formatter.date, true), "month")) {
              datepicker.value.previous = (0, import_dayjs.default)(s2, props.formatter.date, true);
              datepicker.value.next = (0, import_dayjs.default)(e, props.formatter.date, true);
            }
            force();
          } else {
            ...
            const [s2, e] = applyValue.value;
            if (!s2.isSame(e, "month")) {
              datepicker.value.previous = s2;
    ...
    const applyDate = () => {
      ...
      if (asRange()) {
        ...
        const [s2] = applyValue.value;
        date = s2;
      }
      if (asRange()) {
        const [s2, e] = date.split(props.separator);
        if (useArray()) {
          emit("update:modelValue", [(0, import_dayjs.default)(s2, props.formatter.date, true).format(props.formatter.date), (0, import_dayjs.default)(e, props.formatter.date, true).format(props.formatter.date)]);
        } else if (useObject()) {
          const obj = {};
    ...
    const isBetweenRange = (date) => {
      ...
      if (hoverValue.value.length > 1) {
        ...
        s2 = (0, import_dayjs.default)(start, props.formatter.date, true);
        e = (0, import_dayjs.default)(end, props.formatter.date, true);
      } else {
        if (useArray()) {
          if (props.autoApply) {
            const [start, end] = props.modelValue;
            s2 = start && (0, import_dayjs.default)(start, props.formatter.date, true);
            e = end && (0, import_dayjs.default)(end, props.formatter.date, true);
          } else {
    ...
    const datepickerClasses = (date) => {
      ...
      if (active) {
        classes = today ? `text-litepie-primary-500 font-semibold dark:text-litepie-primary-400 rounded-full` : disabled ? `text-litepie-secondary-600 font-normal disabled:text-litepie-secondary-500 disabled:cursor-not-allowed rounded-full` : date.isBetween(s2, e, "date", "()") ? `text-litepie-secondary-700 font-medium dark:text-litepie-secondary-100 rounded-full` : `text-litepie-secondary-600 font-medium dark:text-litepie-secondary-200 rounded-full`;
      }
      if (off) {
        classes = `text-litepie-secondary-400 font-light disabled:cursor-not-allowed`;
      }
      if (s2 && e && !off) {
        if (date.isSame(s2, "date")) {
          classes = e.isAfter(s2, "date") ? "bg-litepie-primary-500 text-white font-bold rounded-l-full disabled:cursor-not-allowed" : "bg-litepie-primary-500 text-white font-bold rounded-r-full disabled:cursor-not-allowed";
          if (s2.isSame(e, "date")) {
            classes = `bg-litepie-primary-500 text-white font-bold rounded-full disabled:cursor-not-allowed`;
          }
        }
        if (date.isSame(e, "date")) {
          classes = e.isAfter(s2, "date") ? "bg-litepie-primary-500 text-white font-bold rounded-r-full disabled:cursor-not-allowed" : "bg-litepie-primary-500 text-white font-bold rounded-l-full disabled:cursor-not-allowed";
          if (s2.isSame(e, "date")) {
            classes = `bg-litepie-primary-500 text-white font-bold rounded-full disabled:cursor-not-allowed`;
          }
        }
      } else if (s2) {
        if (date.isSame(s2, "date") && !off) {
          classes = `bg-litepie-primary-500 text-white font-bold rounded-full disabled:cursor-not-allowed`;
        }
      }
      return classes;
    ...
    const forceEmit = (s2, e) => {
      datepicker.value.previous = (0, import_dayjs.default)(s2, props.formatter.date, true);
      datepicker.value.next = (0, import_dayjs.default)(e, props.formatter.date, true);
      if (import_dayjs.default.duration(datepicker.value.next.diff(datepicker.value.previous)).$d.months === 2 || import_dayjs.default.duration(datepicker.value.next.diff(datepicker.value.previous)).$d.months === 1 && import_dayjs.default.duration(datepicker.value.next.diff(datepicker.value.previous)).$d.days === 7) {
    ...
    const emitShortcut = (s2, e) => {
      if (asRange()) {
        if (props.autoApply) {
          ...
          pickerValue.value = `${s2}${props.separator}${e}`;
        } else {
          applyValue.value = [(0, import_dayjs.default)(s2, props.formatter.date, true), (0, import_dayjs.default)(e, props.formatter.date, true)];
        }
      } else {
        if (props.autoApply) {
          if (useArray()) {
            emit("update:modelValue", [s2]);
          } else if (useObject()) {
            const obj = {};
            const [start] = Object.keys(props.modelValue);
            obj[start] = s2;
    ...
    const setToToday = () => {
      const s2 = (0, import_dayjs.default)().format(props.formatter.date);
      const e = (0, import_dayjs.default)().format(props.formatter.date);
      emitShortcut(s2, e);
    };
    const setToYesterday = () => {
      const s2 = (0, import_dayjs.default)().subtract(1, "day").format(props.formatter.date);
      const e = (0, import_dayjs.default)().subtract(1, "day").format(props.formatter.date);
      emitShortcut(s2, e);
    };
    const setToLastDay = (day) => {
      const s2 = (0, import_dayjs.default)().subtract(day - 1, "day").format(props.formatter.date);
      const e = (0, import_dayjs.default)().format(props.formatter.date);
      emitShortcut(s2, e);
    };
    const setToThisMonth = () => {
      const s2 = (0, import_dayjs.default)().date(1).format(props.formatter.date);
      const e = (0, import_dayjs.default)().date((0, import_dayjs.default)().daysInMonth()).format(props.formatter.date);
      emitShortcut(s2, e);
    };
    const setToLastMonth = () => {
      const s2 = (0, import_dayjs.default)().date(1).subtract(1, "month").format(props.formatter.date);
      const e = (0, import_dayjs.default)().date(0).format(props.formatter.date);
      emitShortcut(s2, e);
    };
    const setToCustomShortcut = (item) => {
      let s2, e;
      const [d2, dd2] = item.atClick();
      s2 = (0, import_dayjs.default)(d2).format(props.formatter.date);
      e = (0, import_dayjs.default)(dd2).format(props.formatter.date);
      emitShortcut(s2, e);
    };
    watch(() => isShow.value, () => {
      nextTick(() => {
    ...
    watchEffect(() => {
      const locale2 = props.i18n;
      nextTick(() => {
        __variableDynamicImportRuntime0__(`./locale/${locale2}.js`).then(() => {
          import_dayjs.default.locale(locale2);
          let s2, e;
          if (asRange()) {
            if (useArray()) {
              if (props.modelValue.length > 0) {
            ...
            if (s2 && e) {
              ...
              if (e.isBefore(s2, "month")) {
                datepicker.value.previous = e;
                datepicker.value.next = s2;
                datepicker.value.year.previous = e.year();
                datepicker.value.year.next = s2.year();
              } else if (e.isSame(s2, "month")) {
                datepicker.value.previous = s2;
                datepicker.value.next = e.add(1, "month");
                datepicker.value.year.previous = s2.year();
                datepicker.value.year.next = s2.add(1, "year").year();
              } else {
                datepicker.value.previous = s2;
                datepicker.value.next = e;
                datepicker.value.year.previous = s2.year();
              ...
              if (!props.autoApply) {
                applyValue.value = [s2, e];
              }
            } else {
              datepicker.value.previous = (0, import_dayjs.default)(props.startFrom);
              datepicker.value.next = (0, import_dayjs.default)(props.startFrom).add(1, "month");
              datepicker.value.year.previous = datepicker.value.previous.year();
              datepicker.value.year.next = datepicker.value.next.year();
            }
          } else {
            ...
            if (s2 && s2.isValid()) {
              pickerValue.value = useToValueFromString(s2, props);
              datepicker.value.previous = s2;
              datepicker.value.next = s2.add(1, "month");
              datepicker.value.year.previous = s2.year();
              datepicker.value.year.next = s2.add(1, "year").year();
              if (!props.autoApply) {
                applyValue.value = [s2];
          ...
          datepicker.value.weeks = import_dayjs.default.weekdaysShort();
          datepicker.value.months = props.formatter.month === "MMM" ? import_dayjs.default.monthsShort() : import_dayjs.default.months();
        }).catch(() => {
...
var _hoisted_10$1 = createVNode("div", {
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createBlock("div", {
  ...
  }, [(openBlock(), createBlock("svg", _hoisted_3$2, [_ctx.pickerValue ? (openBlock(), createBlock("path", _hoisted_4$1)) : (openBlock(), createBlock("path", _hoisted_5$1))]))])])])]), createVNode(Transition, {
    ...
    }, null, 8, ["shortcuts", "as-range", "as-single", "i18n"])) : createCommentVNode("", true), createVNode("div", _hoisted_8$1, [_ctx.asRange() && !_ctx.asSingle ? (openBlock(), createBlock("div", _hoisted_9$1, [_hoisted_10$1])) : createCommentVNode("", true), createVNode("div", {
...
import_dayjs.default.locale(locale, null, true);
...
import_dayjs.default.locale(locale$1, null, true);
...
import_dayjs.default.locale(locale$2, null, true);
...
import_dayjs.default.locale(locale$3, null, true);
...
import_dayjs.default.locale(locale$4, null, true);
...
import_dayjs.default.locale(locale$5, null, true);
...
import_dayjs.default.locale(locale$6, null, true);
...
import_dayjs.default.locale(locale$7, null, true);
...
import_dayjs.default.locale(locale$8, null, true);
...
import_dayjs.default.locale(locale$9, null, true);
...
import_dayjs.default.locale(locale$a, null, true);
...
import_dayjs.default.locale(locale$b, null, true);
...
import_dayjs.default.locale(locale$c, null, true);
...
import_dayjs.default.locale(locale$d, null, true);
...
import_dayjs.default.locale(locale$e, null, true);
...
import_dayjs.default.locale(locale$f, null, true);
...
import_dayjs.default.locale(locale$g, null, true);
...
import_dayjs.default.locale(locale$h, null, true);
...
import_dayjs.default.locale(locale$i, null, true);
...
import_dayjs.default.locale(locale$j, null, true);
...
import_dayjs.default.locale(locale$k, null, true);
...
import_dayjs.default.locale(locale$l, null, true);
...
import_dayjs.default.locale(locale$m, null, true);
...
import_dayjs.default.locale(locale$n, null, true);
...
import_dayjs.default.locale(locale$o, null, true);
...
import_dayjs.default.locale(locale$p, null, true);
...
import_dayjs.default.locale(locale$q, null, true);
...
import_dayjs.default.locale(locale$r, null, true);
...
import_dayjs.default.locale(locale$s, null, true);
...
import_dayjs.default.locale(locale$t, null, true);
var enCa = Object.freeze({
  __proto__: null,
  "default": locale$t
});
var locale$u = {
...
import_dayjs.default.locale(locale$u, null, true);
...
import_dayjs.default.locale(locale$v, null, true);
...
import_dayjs.default.locale(locale$w, null, true);
...
import_dayjs.default.locale(locale$x, null, true);
...
import_dayjs.default.locale(locale$y, null, true);
...
import_dayjs.default.locale(locale$z, null, true);
...
var months$1 = function months2(dayjsInstance, format) {
...
import_dayjs.default.locale(locale$_, null, true);
...
import_dayjs.default.locale(locale$10, null, true);
...
import_dayjs.default.locale(locale$11, null, true);
...
import_dayjs.default.locale(locale$12, null, true);
...
import_dayjs.default.locale(locale$13, null, true);
...
import_dayjs.default.locale(locale$14, null, true);
...
import_dayjs.default.locale(locale$15, null, true);
...
import_dayjs.default.locale(locale$16, null, true);
...
import_dayjs.default.locale(locale$17, null, true);
...
import_dayjs.default.locale(locale$18, null, true);
...
import_dayjs.default.locale(locale$19, null, true);
...
import_dayjs.default.locale(locale$1a, null, true);
...
import_dayjs.default.locale(locale$1b, null, true);
...
import_dayjs.default.locale(locale$1c, null, true);
...
var monthStandalone$1 = "sausis_vasaris_kovas_balandis_gegu\u017E\u0117_bir\u017Eelis_liepa_rugpj\u016Btis_rugs\u0117jis_spalis_lapkritis_gruodis".split("_");
var MONTHS_IN_FORMAT$1 = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?|MMMM?(\[[^\[\]]*\]|\s)+D[oD]?/;
var months$2 = function months3(dayjsInstance, format) {
...
import_dayjs.default.locale(locale$1d, null, true);
...
import_dayjs.default.locale(locale$1e, null, true);
...
import_dayjs.default.locale(locale$1f, null, true);
...
import_dayjs.default.locale(locale$1g, null, true);
...
import_dayjs.default.locale(locale$1h, null, true);
...
import_dayjs.default.locale(locale$1i, null, true);
...
import_dayjs.default.locale(locale$1j, null, true);
...
import_dayjs.default.locale(locale$1k, null, true);
...
import_dayjs.default.locale(locale$1l, null, true);
...
import_dayjs.default.locale(locale$1m, null, true);
...
import_dayjs.default.locale(locale$1n, null, true);
...
import_dayjs.default.locale(locale$1o, null, true);
...
import_dayjs.default.locale(locale$1p, null, true);
...
import_dayjs.default.locale(locale$1q, null, true);
...
import_dayjs.default.locale(locale$1r, null, true);
...
import_dayjs.default.locale(locale$1s, null, true);
...
import_dayjs.default.locale(locale$1t, null, true);
...
import_dayjs.default.locale(locale$1u, null, true);
...
import_dayjs.default.locale(locale$1v, null, true);
...
var months$3 = function months4(dayjsInstance, format) {
...
import_dayjs.default.locale(locale$1w, null, true);
...
import_dayjs.default.locale(locale$1x, null, true);
...
import_dayjs.default.locale(locale$1y, null, true);
...
import_dayjs.default.locale(locale$1z, null, true);
...
var months$4 = function months5(dayjsInstance, format) {
...
function translate$2(number, withoutSuffix, key, isFuture) {
  ...
  switch (key) {
    ...
    case "mm":
      if (withoutSuffix || isFuture) {
        return result + (plural$3(number) ? "min\xFAty" : "min\xFAt");
      }
    ...
    case "hh":
      if (withoutSuffix || isFuture) {
        return result + (plural$3(number) ? "hodiny" : "hod\xEDn");
      }
      return result + "hodinami";
    case "d":
    ...
    case "dd":
      if (withoutSuffix || isFuture) {
        return result + (plural$3(number) ? "dni" : "dn\xED");
      }
      return result + "d\u0148ami";
    case "M":
...
var translator = {
  ...
  relativeTimeFormatter: function relativeTimeFormatter2(number, withoutSuffix, key, isFuture) {
...
var translator$1 = {
  ...
  relativeTimeFormatter: function relativeTimeFormatter3(number, withoutSuffix, key, isFuture) {
    ...
    var word = translator$1.correctGrammarCase(number, wordKey);
...
var months$5 = function months6(dayjsInstance, format) {
...
import_dayjs.default.locale(locale$1_, null, true);
...
import_dayjs.default.locale(locale$20, null, true);
...
import_dayjs.default.locale(locale$21, null, true);
...
import_dayjs.default.locale(locale$22, null, true);
...
import_dayjs.default.locale(locale$23, null, true);
...
import_dayjs.default.locale(locale$24, null, true);
...
var locale$25 = {
  ...
  monthsShort: "1\u6708_2\u6708_3\u6708_4\u6708_5\u6708_6\u6708_7\u6708_8\u6708_9\u6708_10\u6708_11\u6708_12\u6708".split("_"),
  ordinal: function ordinal134(number, period) {
    switch (period) {
      case "W":
        return number + "\u5468";
      default:
  ...
  meridiem: function meridiem4(hour, minute) {
...
import_dayjs.default.locale(locale$25, null, true);
...
import_dayjs.default.locale(locale$26, null, true);
...
import_dayjs.default.locale(locale$27, null, true);
...
var locale$28 = {
  ...
  months: "\u4E00\u6708_\u4E8C\u6708_\u4E09\u6708_\u56DB\u6708_\u4E94\u6708_\u516D\u6708_\u4E03\u6708_\u516B\u6708_\u4E5D\u6708_\u5341\u6708_\u5341\u4E00\u6708_\u5341\u4E8C\u6708".split("_"),
  monthsShort: "1\u6708_2\u6708_3\u6708_4\u6708_5\u6708_6\u6708_7\u6708_8\u6708_9\u6708_10\u6708_11\u6708_12\u6708".split("_"),
  ordinal: function ordinal137(number, period) {
    switch (period) {
      case "W":
        return number + "\u5468";
      default:
  ...
  meridiem: function meridiem5(hour, minute) {
    var hm = hour * 100 + minute;
    if (hm < 600) {
      return "\u51CC\u6668";
    } else if (hm < 900) {
...
import_dayjs.default.locale(locale$28, null, true);
var zh = Object.freeze({
  __proto__: null,
  "default": locale$28
});
var litepie_datepicker_esm_default = entry_esm;

// dep:litepie-datepicker
var litepie_datepicker_default = litepie_datepicker_esm_default;
export {
  litepie_datepicker_default as default
};
//# sourceMappingURL=litepie-datepicker.js.map
